...
void main() => runApp(fivepdf());

class fivepdf extends StatefulWidget {
  @override
  _fivepdfState createState() => _fivepdfState();
}

class _fivepdfState extends State<fivepdf> {
  String pathPDF = "";
  ...
  void initState() {
    super.initState();
    fromAsset('assets/1.pdf', '1.pdf').then((f) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('PDF Viewing')),
